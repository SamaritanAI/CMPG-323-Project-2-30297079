...
namespace CMPG_323_Project_2_30297079.Controllers
{
    ...
    {
        private readonly cmpg323proj2Context _context;

        public OrderDetailsController(cmpg323proj2Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<OrderDetail>> PostOrderDetail(OrderDetail orderDetail)
        {
          if (_context.OrderDetails == null)
          {
              return Problem("Entity set 'cmpg323proj2Context.OrderDetails'  is null.");
          }
